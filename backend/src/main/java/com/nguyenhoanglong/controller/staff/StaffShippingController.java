...
public class StaffShippingController {
    ...
    public ResponseEntity<?> shipment(@PathVariable UUID id) {
    ...
    public ResponseEntity<?> updateTrackingCode(@PathVariable UUID id, @RequestBody TrackingRequest request) {
    ...
    public ResponseEntity<?> startShipping(@PathVariable UUID id) {
    ...
    public ResponseEntity<?> resolveException(@PathVariable UUID id, @RequestBody ResolveRequest request) {
        return ResponseEntity.ok(service.resolveException(id, request.note()));
    }

    @PostMapping("/shipments/{id}/proof")
    public ResponseEntity<?> proofOfDelivery(@PathVariable UUID id, @RequestBody ProofRequest request) {
    ...
    public ResponseEntity<?> reconcileCod(@PathVariable UUID id) {
        return ResponseEntity.ok(service.reconcileCod(id));
    }

    public record ShipmentRequest(UUID orderId, String carrierName, String trackingCode, BigDecimal codAmount) {}
    public record TrackingRequest(String trackingCode) {}
    public record ExceptionRequest(UUID shipmentId, String type, String description) {}
