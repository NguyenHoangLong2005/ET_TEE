...
type Reservation = {
  ...
  id?: string;
  order?: { orderId?: number; id?: string; orderCode?: string };
  productId: string;
  quantity: number;
  status: string;
};
