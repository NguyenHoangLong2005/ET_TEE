...
export const metadata = { title: 'Hướng dẫn chọn size | ET.TEE' };
  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 xl:px-8 py-16 max-w-2xl">
        ...
        <h1 className="text-3xl font-black tracking-tight uppercase mb-4 text-slate-900">Bảng size tham khảo</h1>
