...
export const metadata = { title: 'Chính sách đổi trả | ET.TEE' };
  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 xl:px-8 py-16 max-w-2xl">
        ...
        <h1 className="text-3xl font-black tracking-tight uppercase mb-4 text-slate-900">Chính sách đổi trả</h1>
